...
#ns3-dev-external-sync-lan --num-ext-nodes=7 &
#ns3-dev-external-sync-wifi --num-ext-nodes=7 &
#ns3-dev-external-sync-wifi --num-ext-nodes=6 --ext-ap-node &
#ns3-dev-external-sync-wifi-adhoc --num-ext-nodes=7 &
ns3-dev-external-sync-lr-wpan --num-ext-nodes=7 &
